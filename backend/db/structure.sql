...
--
-- Name: index_cocktails_on_instructions_ja_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cocktails_on_instructions_ja_trgm ON public.cocktails USING gin (instructions_ja public.gin_trgm_ops);


--
-- Name: index_cocktails_on_instructions_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cocktails_on_instructions_trgm ON public.cocktails USING gin (instructions public.gin_trgm_ops);
...
--
-- Name: index_cocktails_on_name_ja_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cocktails_on_name_ja_trgm ON public.cocktails USING gin (name_ja public.gin_trgm_ops);


--
-- Name: index_cocktails_on_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cocktails_on_name_trgm ON public.cocktails USING gin (name public.gin_trgm_ops);
...
--
-- Name: index_ingredients_on_name_ja_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ingredients_on_name_ja_trgm ON public.ingredients USING gin (name_ja public.gin_trgm_ops);


--
-- Name: index_ingredients_on_name_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_ingredients_on_name_trgm ON public.ingredients USING gin (name public.gin_trgm_ops);
