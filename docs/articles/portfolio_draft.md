# 今日の気分に寄り添うカクテル検索サービス「Today’s Cocktail」

## TL;DR

- バーで「何にしよう…」と迷う 30 秒と、家で「何が作れるんだっけ？」を減らしたい。その等身大の不便から生まれたカクテル検索アプリです。
...
このプロダクトは「小さな不便を丁寧に解く」ことを核に作りました。使い心地や改善アイデアをぜひフィードバックいただけると嬉しいです。3 分だけでも、トップ→検索→詳細の流れを触ってみてください。迷いが少し軽くなる体験を目指しています。
